...
class RoverState():
    def __init__(self):
        ...
        self.pitch = 0.0 # Current pitch angle
        self.roll = 0.0 # Current roll angle
        ...
        self.obstacle_angles = None # Angles of navigable terrain pixels
        self.obstacle_dists = None # Distances of navigable terrain pixels
